...
from .views import NewMessageView, RetrieveMessagesView, HealthCheckView, DeleteMessageView, ReplyMessageView
...
urlpatterns = [
    ...
    path('reply/<int:message_id>/', ReplyMessageView.as_view(), name='reply-message'),
]